...
public class YouTube {
    ...
    public static String getStreamURL(String url) {
        return getYouTubeStream(Internet.text(url));
    }

    private static String staticPlayerCode = "";
    ...
    private static String getYouTubeStream(final String html) {
    ...
    private static String signDecipher(final String signature, final String playercode) {
        try {
